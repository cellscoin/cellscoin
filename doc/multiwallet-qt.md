...
In order to support loading of multiple wallets in cellscoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cellscoin.cpp.
...
Changes to cellscoin.cpp
----------------------
cellscoin.cpp is the entry point into cellscoin-qt, and as such, will require some minor modifications to provide hooks for

...
This mechanism has been integrated into Bitcore-Node-CELLSCOIN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/CELLSCOIN-Project/insight-api-cellscoin#web-socket-api](https://github.com/CELLSCOIN-Project/insight-api-cellscoin#web-socket-api) 
* API: [https://github.com/CELLSCOIN-Project/insight-api-cellscoin#swifttx-transactions](https://github.com/CELLSCOIN-Project/insight-api-cellscoin#swifttx-transactions) 
...
By default, the CELLSCOIN Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CELLSCOIN Core daemon:

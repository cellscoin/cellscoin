                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Cellscoin from zCellscoin"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zCellscoin"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zCellscoin));

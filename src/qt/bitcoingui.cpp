                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CELLSCOIN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CELLSCOIN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cellscoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCELLSCOIN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CELLSCOIN Core"), this);
    aboutAction->setStatusTip(tr("Show information about CELLSCOIN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CELLSCOIN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CELLSCOIN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CELLSCOIN addresses"));
    ...
    openAction->setStatusTip(tr("Open a CELLSCOIN: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CELLSCOIN Core help message to get a list with possible CELLSCOIN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CELLSCOIN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CELLSCOIN network", "", count));
}
...
{
    QString strTitle = tr("CELLSCOIN Core"); // default title

...
public:
    ...
    void setZCellscoinControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzCELLSCOIN_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzCELLSCOIN_clicked();
    void on_pushButtonZCellscoinControl_clicked();

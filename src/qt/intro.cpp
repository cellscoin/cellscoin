...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CELLSCOIN Core"),
     ...
     * override -datadir in the cellscoin.conf file in the default data directory
     * (to be consistent with cellscoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())

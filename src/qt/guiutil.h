...
/** Utility functions used by the CELLSCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render CELLSCOIN addresses in monospace font
...
// Parse "cellscoin:" URI into recipient object, return true on successful parsing

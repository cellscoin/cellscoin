...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Cellscoin Core cellscoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cellscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cellscoin transaction") + "\n" +
                               "  cellscoin-tx [options] -create [commands]   " + _("Create hex-encoded cellscoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cellscoin transaction

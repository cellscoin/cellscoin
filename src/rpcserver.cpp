...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop CELLSCOIN server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "CELLSCOIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Cellscoin features */
        {"cellscoin", "masternode", &masternode, true, true, false},
        {"cellscoin", "listmasternodes", &listmasternodes, true, true, false},
        {"cellscoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cellscoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cellscoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cellscoin", "masternodedebug", &masternodedebug, true, true, false},
        {"cellscoin", "startmasternode", &startmasternode, true, true, false},
        {"cellscoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cellscoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cellscoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cellscoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cellscoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cellscoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cellscoin", "mnbudget", &mnbudget, true, true, false},
        {"cellscoin", "preparebudget", &preparebudget, true, true, false},
        {"cellscoin", "submitbudget", &submitbudget, true, true, false},
        {"cellscoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cellscoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cellscoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cellscoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cellscoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cellscoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cellscoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cellscoin", "checkbudgets", &checkbudgets, true, true, false},
        {"cellscoin", "mnsync", &mnsync, true, true, false},
        {"cellscoin", "spork", &spork, true, true, false},
        {"cellscoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"cellscoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cellscoind, or the -server option to cellscoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cellscoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:51883/\n";
}

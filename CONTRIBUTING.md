Contributing to CELLSCOIN Core
============================

The CELLSCOIN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CELLSCOIN Core project, and is not to be
confused with overall CELLSCOIN Network Protocol consensus changes.

Whether a pull request is merged into CELLSCOIN Core rests with the project merge
...
Patches that change CELLSCOIN consensus rules are considerably more involved than
...
Where a patch set proposes to change the CELLSCOIN consensus, it must have been
...
The project leader is the release manager for each CELLSCOIN Core release.

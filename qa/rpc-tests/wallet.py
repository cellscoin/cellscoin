...
#   c) node1 mines 32 blocks, so now node 0 has 60001cellscoin, node 1 has 4250cellscoin, node2 has none.
#   d) node0 sends 601 cellscoin to node2, in two transactions (301 cellscoin, then 300 cellscoin).

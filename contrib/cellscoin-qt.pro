...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/cellscoin-cli.cpp \
           src/cellscoin-tx.cpp \
           src/cellscoin.cpp \
           src/db.cpp \
           ...
           src/qt/cellscoin.cpp \
           src/qt/cellscoinstrings.cpp \
...
RESOURCES += src/qt/cellscoin.qrc src/qt/cellscoin_locale.qrc

TRANSLATIONS += src/qt/locale/cellscoin_bg.ts \
                src/qt/locale/cellscoin_de.ts \
                src/qt/locale/cellscoin_en.ts \
                src/qt/locale/cellscoin_es.ts \
                src/qt/locale/cellscoin_fi.ts \
                src/qt/locale/cellscoin_fr.ts \
                src/qt/locale/cellscoin_it.ts \
                src/qt/locale/cellscoin_ja.ts \
                src/qt/locale/cellscoin_pl.ts \
                src/qt/locale/cellscoin_pt.ts \
                src/qt/locale/cellscoin_ru.ts \
                src/qt/locale/cellscoin_sk.ts \
                src/qt/locale/cellscoin_sv.ts \
                src/qt/locale/cellscoin_vi.ts \
                src/qt/locale/cellscoin_zh_CN.ts \
                src/qt/locale/cellscoin_zh_TW.ts
